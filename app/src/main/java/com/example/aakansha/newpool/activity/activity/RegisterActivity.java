...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText inputFullEmployee_id;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputFullEmployee_id = (EditText) findViewById(R.id.employee_id);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                String employee_id = inputFullEmployee_id.getText().toString().trim();
                String password = inputPassword.getText().toString().trim();

                if (!employee_id.isEmpty() && !password.isEmpty()) {
                    registerUser(employee_id, password);
                } else {
    ...
    /**
     * Function to store user in MySQL database will post params(tag, employee_id,
     * email, password) to register url
     * */
    private void registerUser(final String employee_id,
