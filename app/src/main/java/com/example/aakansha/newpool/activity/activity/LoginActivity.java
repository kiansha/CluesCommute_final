...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputEmployeeId = (EditText) findViewById(R.id.login_employee_id);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String login_employee_id = inputEmployeeId.getText().toString().trim();
                String password = inputPassword.getText().toString().trim();

                // Check for empty data in the form
                if (!login_employee_id.isEmpty() && !password.isEmpty()) {
                    // login user
                    checkLogin(login_employee_id, password);
                } else {
     ...
     * */
    private void checkLogin(final String login_employee_id, final String password) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        db.addUser(employee_id, email, uid, created_at);
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("employee_id", login_employee_id);
